...
- (BOOL) makeDisplayList:(GLint)listNum withImage:(NSImage *)theImage
{
   ...
   NSInteger bytesPerRow, pixelsHigh, pixelsWide, samplesPerPixel;
   unsigned char *bitmapBytes;
   int currentBit, byteValue;
   unsigned char *newBuffer, *movingBuffer;
   NSInteger rowIndex, colIndex;
   ...
   glBitmap((GLsizei)pixelsWide, (GLsizei)pixelsHigh, 0, 0, pixelsWide, 0, newBuffer);
   glEndList();
   free(newBuffer);
